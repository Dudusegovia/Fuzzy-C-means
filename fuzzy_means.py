...
if __name__ == "__main__":
    K_FUZZY(dataf=data, num_clusters=3, rodadas_max=100).to_excel("resultado.xlsx", index=False) # A função retorna um dataframe atualizado com a coluna 'cluster' adicionada
